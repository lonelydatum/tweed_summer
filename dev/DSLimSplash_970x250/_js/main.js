...
function init(){
	...
	tl.from(["._swirl", "._swirl2", "._lime", "._lime2", "._lime3"], {duration:.4, scale:0, ease:"custom", onComplete:()=>{		
		TweenLite.to(["._swirl", "._swirl2", "._lime", "._lime2", "._lime3"], looper)
	}})

	tl.from(["._lemon", "._lemon2", "._lemon3", "._lemon-ring"], {duration:.4, scale:0, ease:"custom", onComplete:()=>{		
