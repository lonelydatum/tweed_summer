...
function start(){
	...
	tl.from(["._swirl", "._lime-bottom", "._lime-top"], {duration:.4, scale:0, ease:Back.easeOut, onComplete:()=>{
		console.log('lkj');
		TweenLite.to(["._swirl", "._lime-bottom", "._lime-top"], {duration:.3, yoyo:true, repeat:8, ease:Linear.easeNone, rotation:"+=11"})

	}})
	tl.from(["._lemon-top", "._lemon-ring", "._lemon-right", "._lemon-left"], {duration:.4, scale:0, ease:Back.easeOut, onComplete:()=>{
